...
public class GroupPaymenttGraphTest {
    ...
    private ExpenseService constructExpenseService() {
        ...
        firstExpense.getBalances().put("A", new Amount(Currency.USD, 10.0));
        firstExpense.getBalances().put("B", new Amount(Currency.USD, 20.0));
    ...
    private HashMap<String, Group> getGroups() {
        ...
        userList.add("B");
        userList.add("C");
        groups.put("123", new Group("Europe", "www.interviewready.io",
                userList));
        return groups;
    }
}
